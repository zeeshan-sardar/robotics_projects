...
(cl:defmethod cl:initialize-instance :after ((m <RGB>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RGB)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name warthog_msgs-msg:<RGB> is deprecated: use warthog_msgs-msg:RGB instead.")))

(cl:ensure-generic-function 'red-val :lambda-list '(m))
(cl:defmethod red-val ((m <RGB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader warthog_msgs-msg:red-val is deprecated.  Use warthog_msgs-msg:red instead.")
  (red m))

(cl:ensure-generic-function 'green-val :lambda-list '(m))
(cl:defmethod green-val ((m <RGB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader warthog_msgs-msg:green-val is deprecated.  Use warthog_msgs-msg:green instead.")
  (green m))

(cl:ensure-generic-function 'blue-val :lambda-list '(m))
(cl:defmethod blue-val ((m <RGB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader warthog_msgs-msg:blue-val is deprecated.  Use warthog_msgs-msg:blue instead.")
  (blue m))
